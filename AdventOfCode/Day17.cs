...
namespace AdventOfCode
{
    internal class Day17
    {
        public void DoItA()
        {
            ...
            bool IsValid(Coord c) => (c.X >= 0 && c.Y >= 0 && c.X <= 3 && c.Y <= 3);
            const string input = "pgflpeqp";
